...
COLUMN_ALIASES: dict[str, str] = {
    ...
    "unidad_academica": "department",
    "organizational_unit": "department",
    "unidad_organizacional": "department",
    "amount": "amount",
    "monto": "amount",
    "importe": "amount",
    "total": "amount",
    ...
    "efectivo_equivalentes": "cash_and_equivalents",
    ...
    "ebitda": "ebitda",
    "utilidad_antes_de_intereses_impuestos_depreciacion_y_amortizacion": "ebitda",
